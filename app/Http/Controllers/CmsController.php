...
class CmsController extends Controller
{
    ...
    public function uploadNews(Request $req) {
        ...
        if(!$req->edit_id){
            ...
            $date = (!$req->edit_date) ? Carbon::now() : $req->edit_date ;

            $file = News::where('id', $req->edit_id)->update([
                'title'             =>  $req->edit_title,
                'description'       =>  $req->edit_desc,
                'topic'             =>  $req->edit_topic,
                'web_link'          =>  $req->edit_link,
                'display_date'      =>  $date,
                'updated_at'        =>  Carbon::now(),
            ]);   
        }
