    ...
    $(document).ready(function () {
        ...
        $(window).on('scroll', function() {
            ...
            if (scroll >= 200) {
                ...
                $('#headerACASIA').attr('src',"/img/acasia/ACASIA_2021.png").attr('width','80').css('bottom','-5px');
            } else {
                $('.app-header').removeClass('sticky-nav');
                $('#headerACASIA').attr('src',"/img/acasia/ACASIA_2021.png").attr('width','145').css('bottom','30px');
            }
        });
            ...
            var start = $.ajax({
                            ...
                            $.each(data, function(i,file){
                                $.each(file, function(i, eachFile){
                                    ...
                                    // max at 29 characters, if more make into ...

                                    $('#sortable').append("<li id=\"draggable\"class=\"ui-state-default ui-widget-content col-md-4 px-0\"><img class=\"img-fluid p-0 rounded\" src=\"/upload/index/"+eachFile.file_path+"\"></li>")
                                });
                            });
                        });
        }
